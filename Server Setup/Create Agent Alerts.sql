...
*** Create Agent Alerts
***
*** Creates a set of SQL Agent Alerts for severity 16-25, and specifically error numbers 823, 824 and 825 which
*** may herald data corruption.
*** Assumes an existing operator 'DBA' for email alerts.
***
*** See https://www.brentozar.com/blitz/configure-sql-server-alerts/
***
*** Ver		Date		Author
*** 1.0		15/08/19	Alex Stuart
***
******************************************************************************************************************/
